...
export type Medicacao = Database["public"]["Tables"]["medicacao"]["Row"];
export type Medicamento = Database["public"]["Tables"]["medicamento"]["Row"];
export type ReceitaMedicamento = Database["public"]["Tables"]["receitamedicamento"]["Row"];
export type Posologia = Database["public"]["Tables"]["posologia"]["Row"];
export type Vacina = Database["public"]["Tables"]["vacina"]["Row"];
export type Vacinacao = Database["public"]["Tables"]["vacinacao"]["Row"];